# The-Geographical-Poverty-Trap-Study
This repository is a case study that I made going over the financial problems with Gen Z and Millennials based by their geographical locations by using Texas data as anchor points
...
![Wealth Cloud](<img width="1019" height="545" alt="output" src="https://github.com/user-attachments/assets/88e0c73c-808d-4b60-8cd2-4634f8d6f211" />)

How to Run:

Clone this repo: git clone https://github.com/KiwiAnomaly/The-Geographical-Poverty-Trap-Study.git

Install dependencies: pip install -r requirements.txt

Open notebooks/Generational_Wealth_Index.ipynb in Jupyter or PyCharm to run the simulation.
